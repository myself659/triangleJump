...
void MoveByPath_6_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MoveByPath_6_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 7238;}

uint get_number_of_components() {return 19;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 5434;}
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_sub(&expaux[0],&circuitConstants[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 63]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
ctx->componentMemory[coffset].templateName = "MoveByPath";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Line_ab";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "Line_bc";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessThan_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 68 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "xProof";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+1927;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "xProofRoot";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 1770 ;
aux_cmp_num += 3;
...
uint csoffset = mySignalStart+3697;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "yProof";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 1770 ;
aux_cmp_num += 3;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "yProofRoot";
mySubcomponents[aux_create+i] = aux_cmp_num;
MiMCSponge_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 1770 ;
aux_cmp_num += 3;
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 3]); // line circom 23
Fr_sub(&expaux[2],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 2]); // line circom 23
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 3]); // line circom 25
Fr_sub(&expaux[2],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 2]); // line circom 25
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&circuitConstants[0]); // line circom 30
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 30. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &signalValues[mySignalStart + 11];
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 4]); // line circom 35
Fr_sub(&expaux[2],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 4]); // line circom 35
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 5]); // line circom 37
Fr_sub(&expaux[2],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 5]); // line circom 37
Fr_mul(&expaux[0],&expaux[1],&expaux[2]); // line circom 37
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 11],&signalValues[mySignalStart + 12]); // line circom 41
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 8]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[1]); // line circom 43
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 43. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &signalValues[mySignalStart + 13];
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 4]); // line circom 47
Fr_sub(&expaux[2],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 4]); // line circom 47
Fr_mul(&expaux[0],&expaux[1],&expaux[2]); // line circom 47
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[1],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 5]); // line circom 49
Fr_sub(&expaux[2],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 5]); // line circom 49
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 13],&signalValues[mySignalStart + 14]); // line circom 53
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 8]); // line circom 54
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&circuitConstants[1]); // line circom 55
...
MoveByPath_6_create(1,0,ctx,"main",0);
MoveByPath_6_run(0,ctx);
}
